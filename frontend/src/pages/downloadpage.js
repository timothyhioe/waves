...
function DownloadPage({ setSongs, songs, searchQuery, onlineSearchResults, handleDownload }) {
    ...
    const handleDownloadClick = async (song) => {
        ...
        try{
            ...
            console.errror('Download error:', error);
                ...
                <div className="results-list">
                    ...
                    <div className="results-table">
                        ...
                        {onlineSearchResults.map((song, index) => (
                            <div key={`${song.source}-${song.id}-${index}`} className="table-row">
                                    ...
                                    {song.youtube_url ? (
                                        ...
                                        >
                                            {isDownloading[song.id] ? (
                                                <span className="loading"><DownloadIcon/></span>
                                            ) : (
                                                <DownloadIcon />
                                            )}
                                        </button>
