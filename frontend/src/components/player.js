        ...
        <div className="player">
            ...
            <div className="player-controls">
                <div className="control-buttons">
                    <button className="control-btn" onClick={handlePrev}><SkipPreviousIcon/></button>
                    <button className="play-pause-btn" onClick={togglePlayPause}>
                        {isPlaying ? <PauseCircleIcon style={{ fontSize: 30 }}/> : <PlayCircleIcon style={{ fontSize: 30 }} />}
                    </button>
                    <button className="control-btn" onClick={handleNext}><SkipNextIcon/></button>
                </div>
